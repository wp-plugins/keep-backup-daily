...
<td><fieldset>
    ...
    <div style="height:160px; background-color:#F3F3F3; overflow:auto; width:50%;">
...
<th scope="row">Server Settings</th>

<td><fieldset>

	

    <label for="max_execution_time">max_execution_time = <input type="number" class="small-text" value="<?php echo $settings['max_execution_time']; ?>" name="max_execution_time" id="max_execution_time">seconds
