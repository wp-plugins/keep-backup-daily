...
<ul class="kbd_rc">
	<li <?php echo $kbd_rc['is_writable']?'class="tick"':'class="cross"';?>> Write Permissions</li>
    <li <?php echo $kbd_rc['ZipArchive']?'class="tick"':'class="cross"';?>>Zip Library</li>  
    <li <?php echo $kbd_rc['mcrypt_create_iv']?'class="tick"':'class="cross"';?>>MCRYPT Library</li>
</ul>
</div>
</td>
