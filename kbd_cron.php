<?php ini_set('max_execution_time', 60*60);
...

		{
...

				{
					...
					/*
					//WORKING ON HTML EMAIL
					$from = "kbd@".str_replace('www.','',$_SERVER['HTTP_HOST']);
					$headers = array();
					$headers[] = "From: Keep Backup Daily <".strip_tags($from).">\r\n";
					...
					*/
					...
					if(wp_mail( $configEmail, basename($zip_file), $_SERVER['HTTP_HOST'].' - Database Backup by Wordpress Plugin Keep Backup Daily', '', array($zip_file) ))
