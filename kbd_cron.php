<?php 
		...
		function kbd_cron_process()
		{
				...
				$settings['max_execution_time'] = (isset($settings['max_execution_time']) && $settings['max_execution_time']>ini_get('max_execution_time'))?$settings['max_execution_time']:ini_get('max_execution_time');
